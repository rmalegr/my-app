...
<template>
  <div id="MainLayout" class="h-screen">
    ...
    <div id="BottomNav" class="fixed z-50 bottom-0 flex w-full h-[70px] boder-t border-t-gray-700 bg-black">
      <div class="flex w-full max-w-[500px] mx-auto flex items-center justify-around">
        <button class="w-full h-full">
          <Icon @click="navigateTo('/')" name="material-symbols:home-outline" size="35" color="#ffffff" />
